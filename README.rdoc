...
If you find yourself installing inherit_views into many plugins a better alternative is to install the
...
Then, in your project's <tt>environment.rb</tt>, add a line like the following after the
<tt>Rails::Initializer.run do |config|</tt> line.
...
* {Topher Fangio}[http://github.com/topherfangio]
