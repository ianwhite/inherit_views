...
module InheritViewsSpec
  describe "The SecondController class (a controller with: inherit_views 'first')" do
    controller_name "inherit_views_spec/second"
  ...
  describe "A SecondController" do
    controller_name "inherit_views_spec/second"
  ...
  describe "A SecondController's actions" do
    controller_name "inherit_views_spec/second"
    integrate_views
  ...
  describe "A SecondController's views" do
    controller_name "inherit_views_spec/second"
