...
module InheritViewsSpec
  describe "The ThirdController class (a controller inheriting from SecondController)" do
  ...
  describe "A ThirdController's actions" do
    controller_name "inherit_views_spec/third"
    integrate_views
